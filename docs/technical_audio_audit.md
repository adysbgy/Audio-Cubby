...
| `raw/sfx/sfx_interact_available_glow_1.wav` | 0.88s | 55.00% | 9.03% | OK |
| `raw/sfx/sfx_interact_tap_1.wav` | 0.22s | 11.85% | 1.01% | OK |
| `raw/sfx/sfx_joystick_drag_soft_1.wav` | 0.41s | 35.00% | 3.99% | OK |
...
| `raw/sfx/sfx_text_type_soft_1.wav` | 0.06s | 3.58% | 0.78% | OK |
| `raw/sfx/sfx_ui_back_soft_1.wav` | 0.45s | 42.00% | 3.12% | OK |
| `raw/sfx/sfx_ui_disabled_soft_1.wav` | 1.72s | 50.06% | 7.02% | OK |
| `raw/sfx/sfx_ui_next_soft_1.wav` | 0.19s | 58.00% | 6.05% | OK |
